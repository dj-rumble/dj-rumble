...
try do
  ...
  single_video_rooms = Enum.with_index(Enum.take(room_ids, 2))
  vulf_video_ids = Enum.slice(video_ids, length(single_video_rooms), 5)
  short_video_ids = Enum.slice(video_ids, length(single_video_rooms) + length(vulf_video_ids), 2)
