defmodule DjRumbleWeb.UserAuthTest do
  use DjRumbleWeb.ConnCase, async: true

  alias DjRumble.Accounts
  alias DjRumbleWeb.UserAuth
  import DjRumble.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, DjRumbleWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      DjRumbleWeb.Endpoint.subscribe(live_socket_id)
