defmodule DjRumbleWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: DjRumbleWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {DjRumbleWeb.LayoutView, "live.html"}
  ...
  defp view_helpers do
    quote do
      ...
      import DjRumbleWeb.LiveHelpers
